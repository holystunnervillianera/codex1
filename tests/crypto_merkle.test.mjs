...
import { decryptBuffer, encryptBuffer, sha256Hex } from '../src/vault_crypto.mjs';
...
assert.equal(decryptBuffer(encrypted.ciphertext, masterKey, encrypted.encryption, Buffer.from('fixture')).toString('utf8'), plaintext.toString('utf8'));
